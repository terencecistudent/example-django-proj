"""
Django settings for booksonline project.
...
ALLOWED_HOSTS = ['localhost', 'teds-books-online.herokuapp.com']
...
WSGI_APPLICATION = 'booksonline.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = 'teds-books-online'
